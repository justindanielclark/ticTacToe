const gameHeader = (root) => {
  ...
  _headerContainer.appendChild(_createPlayerOption());
  _headerContainer.appendChild(document.createElement('hr'));
  ...
  function _createPlayerOption(){
    ...
    const button = document.createElement('button');
      ...
      button.innerText = 'Start Player Game';
